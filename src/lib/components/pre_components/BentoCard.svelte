...
<div
	...
	class={cn(
		...
		// dark styles
		'dark:bg-dark_c transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]',
		className
	)}
>
	<div class=" overflow-hidden">
		<img class="h-auto" src={background} alt={name} />
	</div>
	<div
	...
	<div
		class="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-black/[.5] group-hover:dark:bg-neutral-800/10"
	/>
</div>
